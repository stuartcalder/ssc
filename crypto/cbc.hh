...
namespace ssc
{
    ...
    public:
        ...
        ~CBC();
        void   manually_set_state(const u8_t * const state_bytes);
        void   encrypt_no_padding(const u8_t *bytes_in, u8_t *bytes_out, const std::size_t size_in, const u8_t *iv = nullptr);
        void   decrypt_no_padding(const u8_t *bytes_in, u8_t *bytes_out, const std::size_t size_in, const u8_t *iv = nullptr);
        std::size_t            decrypt(const u8_t *bytes_in, u8_t *bytes_out, const std::size_t size_in, const u8_t *iv = nullptr);
        std::size_t            encrypt(const u8_t *bytes_in, u8_t *bytes_out, const std::size_t size_in, const u8_t *iv = nullptr);
    private:
        /* PRIVATE STATE */
        Block_Cipher_t  __blk_cipher;
        u8_t            __state[Block_Bytes] = { 0 };
        /* PRIVATE INTERFACE */
        static std::size_t        _apply_iso_iec_7816_padding(u8_t *bytes, const std::size_t prepadding_size);
        static std::size_t  _count_iso_iec_7816_padding_bytes(const u8_t * const bytes, const std::size_t padded_size);
    ...
    template<typename Block_Cipher_t, std::size_t Block_Bits>
    std::size_t CBC<Block_Cipher_t,Block_Bits>::_apply_iso_iec_7816_padding(u8_t *bytes, const std::size_t prepadding_size)
    {
    ...
    template<typename Block_Cipher_t, std::size_t Block_Bits>
    std::size_t CBC<Block_Cipher_t,Block_Bits>::_count_iso_iec_7816_padding_bytes(const u8_t * const bytes, const std::size_t padded_size)
    {
        using namespace std;
        size_t count = 0;
    ...
    std::size_t CBC<Block_Cipher_t,Block_Bits>::encrypt(const u8_t *bytes_in, u8_t *bytes_out, const std::size_t size_in, const u8_t *iv)
    {
        ...
        static_assert(sizeof(__state) == Block_Bytes);
        ...
        return _calculate_padded_ciphertext_size( size_in );
    }
    template<typename Block_Cipher_t, std::size_t Block_Bits>
    std::size_t CBC<Block_Cipher_t,Block_Bits>::decrypt(const u8_t *bytes_in, u8_t *bytes_out, const std::size_t size_in, const u8_t *iv)
    {
        ...
        for ( std::size_t b_off = 0; b_off <= last_block_offset; b_off += Block_Bytes ) {
            ...
            memcpy( __state  , ciphertext, Block_Bytes );
        }
        zero_sensitive( buffer    , Block_Bytes );
